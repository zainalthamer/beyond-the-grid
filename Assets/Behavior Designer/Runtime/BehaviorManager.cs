...
namespace BehaviorDesigner.Runtime
{
    ...
    public class BehaviorManager : MonoBehaviour
    {
        ...
        {
            if (behavior.IsAsyncLoading) {
                Debug.LogWarning("Warning: Unable to enable behavior tree when the tree is already being loaded.");
                return;
            }
